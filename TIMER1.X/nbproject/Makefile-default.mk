...
SOURCEFILES_QUOTED_IF_SPACED=TIMER1.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/TIMER1.o
POSSIBLE_DEPFILES=${OBJECTDIR}/TIMER1.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/TIMER1.o

# Source Files
SOURCEFILES=TIMER1.asm
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/TIMER1.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/TIMER1.o: TIMER1.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/TIMER1.o 
	${MP_AS} -mcpu=PIC16F877A -c \
	-o ${OBJECTDIR}/TIMER1.o \
	TIMER1.asm \
...
${DISTDIR}/TIMER1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/TIMER1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
